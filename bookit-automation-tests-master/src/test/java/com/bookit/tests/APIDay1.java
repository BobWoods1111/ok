...
public class APIDay1 {
	...
	public void simpleStatusCode() {
		...
		when().get("http://107.22.128.211:1000/ords/hr/employees")
		.then().statusCode(200);	
	}
	...
	public void printResponse() {
		when().get("http://107.22.128.211:1000/ords/hr/countries")
		.body().prettyPrint();
	...
	public void negativeGet() {
		...
		when().get("http://107.22.128.211:1000/ords/hr/employees/1234")
		.then().statusCode(404);	
	...
	public void negativeGetWithBody() {
		Response response = when().get("http://107.22.128.211:1000/ords/hr/employees");
				
		//status code check
		assertEquals(response.statusCode(), 200);
		
		//check body includes "Not Found"
		assertTrue(response.asString().contains("items"));
	...
	public void verifyContentType() {
		...
		given().accept(ContentType.JSON).
		when().get("http://107.22.128.211:1000/ords/hr/employees/110")
	...
	public void verifyRegionCount() {
		...
		.and().assertThat().body("items.region_id", Matchers.hasSize(8))
